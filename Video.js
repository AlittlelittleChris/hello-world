(function () {
    window.onload=function () {
        ...
        function sendCaption (argument) {
            var ismoveInputEle = true
            var inputEleTxt = inputEle.value
            var timeAt = parseInt( video.currentTime )
            var inputIsmoveValue = ismoveInputEle.checked
            var temObj = {content:inputEleTxt,time:timeAt,ismove:ismoveInputEle,colorIndex:selectedColorIndex}
